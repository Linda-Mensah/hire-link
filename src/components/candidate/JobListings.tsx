            ...
            <div className="p-5 sm:p-6 flex-1">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h3
                    className="text-lg sm:text-xl font-semibold text-stone-800 
                               leading-tight break-words pr-2"
                  >
                    {job.title}
                  </h3>
                </div>
                <Briefcase className="h-5 w-5 text-stone-400 flex-shrink-0" />
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center text-stone-700 text-sm">
                  <MapPin className="h-4 w-4 text-stone-400 mr-3 flex-shrink-0" />
                  <span className="truncate">{job.location}</span>
                </div>
                <div className="flex items-center text-stone-700 text-sm">
                  <Banknote className="h-4 w-4 text-stone-400 mr-3 flex-shrink-0" />
                  <span className="truncate">{job.salaryRange}</span>
                </div>
                <div className="flex items-center text-stone-700 text-sm">
                  <Calendar className="h-4 w-4 text-stone-400 mr-3 flex-shrink-0" />
